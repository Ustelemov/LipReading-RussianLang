...
- [ ] 7. Создать скрипт для получения статистики по фонемах из данных о фонемам по кадрам (6 пункт): 
  - 1. Сколько раз фонема вообще появлялась (длительность по кадрам при этом не учитывается, считается именно появление). Можно будет судить о частоте использования фонемы. Построить график.
  - 2. Сделать список длительностей (в кадрах) по каждой фонеме, тогда можно будет подсчитать:
    - Скольцо процентов от общего числа кадров заняла фонема. Построить график
    - Самую частую длительность в кадрах. Построить график.
    - Минимальную длительность в кадре
    - Максимальную длительность в кадрах
    - Среднюю длитетельность в кадрах
    - Среднее квадратичное отклонение
  - 3. Пункт b (мин,макс, среднее и отклонение) для всех фонем в целом.
