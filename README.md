...
- [X] 7. ~~Создать скрипт для получения статистики о встречи фонем:~~
  ...
  - 1. Сколько раз фонема вообще появлялась (длительность по кадрам при этом не учитывается, считается именно появление). Можно будет судить о частоте использования фонемы и каков процент встреч данной фонемы от общего числа встреч. Построить графики.
