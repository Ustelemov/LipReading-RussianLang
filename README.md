...
- [ ] 4. Создать скрипт для получения словаря: слов->транскрипция по фонемам
- [ ] 4. Добавить словари: слова->транскрипции по фонемам, словарь фонем (с ключом и значением), для работы классификатора, словарь фонем с примерами использования
