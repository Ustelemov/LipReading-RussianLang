...
- [Скрипты](scripts/)
  ...
  - [get_phonemes_appearence_stat.py](scripts/python get_phonemes_duration_stat.py) - получение статистике по количеству встреч фонем: сколько раз использовалась фонема, независимо от длины в кадрах
- [Cловари](dicts/)
